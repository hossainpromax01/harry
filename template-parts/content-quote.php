<?php if(is_single()) : ?>
      <article id="<?php the_ID(); ?>" <?php post_class("harry-post-format-quote"); ?> >  
      <div class="postbox__quote postbox__quote-style-3 mb-30">
            <div class="blog__grid-quote mb-30">
             ...
             <?php echo get_template_part('template-parts/blog/meta'); ?>
              <div class="postbox__details-content-wrapper mb-60">
                  <h3 class="postbox__details-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                  <?php the_content(); ?>
            </div>
...
<?php else : ?>
<article id="<?php the_ID(); ?>" <?php post_class("harry-post-format-quote postbox__item format-quote mb-50 transition-3"); ?> >
