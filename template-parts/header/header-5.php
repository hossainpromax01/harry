 ...
 <header>
         <div class="header__area">
            <div class="header__bottom-13 header__bottom-13-white header__padding-7 header__black-3 header__bottom-border-4 header__sticky" id="header-sticky">
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-xxl-5 col-xl-3 col-lg-8 col-md-8 col-sm-7 col-4">
                           <div class="header__bottom-right-13 d-flex justify-content-end align-items-center pl-30">
                              <div class="header__search-13">
                                 <form action="/" method="get">
                                    <div class="header__search-input-13 d-none d-xxl-block">
                                       <input type="text" name="s" value="<?php the_search_query(); ?>" placeholder="<?php echo esc_attr__('Type here to search...','harry' )?>">
                                       <button type="submit">
                              ...
                              <div class="header__action-13 d-none d-lg-block">
                                 <ul>
                                    <li class="d-xxl-none">
         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
            <div class="cartmini__top-wrapper ">
                  ...
                  <div class="cartmini__widget-item">
                     <div class="cartmini__thumb">
                        <a href="product-details.html">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/product-1.jpg" alt="">
                        </a>
                     </div>
               ...
               <div class="cartmini__empty text-center d-none">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/cartmini/empty-cart.png" alt="">
